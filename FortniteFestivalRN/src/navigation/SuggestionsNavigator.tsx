...
const Stack = createNativeStackNavigator<SuggestionsStackParamList>();
...
function SuggestionsListWrapper({navigation}: any) {
  return (
    <SuggestionsScreen
...
export function SuggestionsNavigator() {
  return (
    <Stack.Navigator
    ...
    >
      <Stack.Screen
        ...
        component={SuggestionsListWrapper}
