...
import {Screen, FrostedSurface, PageHeader, InstrumentCard, useCardGrid, WIN_SCROLLBAR_INSET, FadeScrollView, Colors, gridStyles, Layout, Gap, Font, LineHeight, Radius, Opacity, MaxWidth} from '@festival/ui';
...
const CARD_BG = Colors.surfaceFrosted;
...
export function SongDetailsView(props: {songId: string; showBack?: boolean; onBack?: () => void}) {
  ...
  return (
    <Screen style={styles.screen} withSafeArea={false}>
      <View
        style={styles.root}
        onLayout={useCallback((e: {nativeEvent: {layout: {width: number}}}) => {
