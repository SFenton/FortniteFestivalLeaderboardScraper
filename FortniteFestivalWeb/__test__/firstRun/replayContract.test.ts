...
const EXPECTED_REGISTERED_FIRST_RUN_REPLAY_CONTRACT = {
  ...
  'shop-new-items': { pageKey: 'shop', version: 1 },
  ...
  'songinfo-new-in-shop': { pageKey: 'songinfo', version: 1, contentKey: 'songinfo-new-in-shop' },
  ...
  'songs-new-in-shop': { pageKey: 'songs', version: 1 },
