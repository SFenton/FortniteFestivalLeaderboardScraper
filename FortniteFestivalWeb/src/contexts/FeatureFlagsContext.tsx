...
const ALL_ON: FeatureFlags = { shop: true, rivals: true, compete: true, leaderboards: true };
const ALL_OFF: FeatureFlags = { shop: false, rivals: false, compete: false, leaderboards: false };
