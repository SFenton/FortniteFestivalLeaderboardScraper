...
export const modalStyles = {
  ...
  /* ── RadioRow ── */
  radioRow: { display: Display.flex, alignItems: Align.center, gap: Gap.none, width: CssValue.full, padding: Gap.none, backgroundColor: CssValue.transparent, border: CssValue.none, borderRadius: Radius.xs, color: Colors.textSecondary, fontSize: Font.md, fontWeight: Weight.semibold, marginBottom: Gap.xs, textAlign: TextAlign.left } as CSSProperties,
  radioRowSelected: { display: Display.flex, alignItems: Align.center, gap: Gap.none, width: CssValue.full, padding: Gap.none, backgroundColor: CssValue.transparent, border: CssValue.none, borderRadius: Radius.xs, color: Colors.textPrimary, fontSize: Font.md, fontWeight: Weight.semibold, marginBottom: Gap.xs, textAlign: TextAlign.left } as CSSProperties,
  radioRowControl: { display: Display.flex, alignItems: Align.center, gap: Gap.xl, flex: 1, minWidth: 0, minHeight: GeneralSize.thumb, boxSizing: BoxSizing.borderBox, padding: Gap.xl, backgroundColor: CssValue.transparent, border: CssValue.none, color: 'inherit', font: 'inherit', cursor: Cursor.pointer, textAlign: TextAlign.left } as CSSProperties,
  ...
  radioInfoBtn: { display: Display.flex, alignItems: Align.center, justifyContent: Justify.center, width: GeneralSize.thumb, height: GeneralSize.thumb, borderRadius: CssValue.circle, backgroundColor: Colors.surfaceMuted, color: Colors.textSecondary, border: CssValue.none, cursor: Cursor.pointer, flexShrink: 0, marginLeft: 'auto', marginRight: Gap.xl, padding: 0 } as CSSProperties,
