...
import { paddingWithSafeAreaBottom, paddingWithSafeAreaTop } from '../../../utils/safeAreaStyles';
...
export const sidebarStyles = {
  ...
  bandProfilePanel: { ...flexColumn, gap: Gap.sm, padding: padding(0, Gap.md) } as CSSProperties,
  bandProfileLink: { ...sidebarLink, minWidth: 0, overflow: 'hidden', padding: padding(0, Gap.md) } as CSSProperties,
  bandProfileName: { flex: 1, minWidth: 0 } as CSSProperties,
  bandProfileType: { color: Colors.textSubtle, fontSize: Font.sm, fontWeight: Weight.semibold, padding: padding(0, Gap.md), marginTop: -Gap.xs } as CSSProperties,
  bandMemberList: { ...flexColumn, gap: Gap.xs } as CSSProperties,
  bandMemberLink: { ...sidebarLink, height: 36, minWidth: 0, overflow: 'hidden', padding: padding(0, Gap.md), fontSize: Font.sm } as CSSProperties,
  bandMemberName: { flex: 1, minWidth: 0 } as CSSProperties,
  bandDeselectBtn: { ...btnDanger, alignSelf: 'flex-start', padding: `${Gap.sm}px ${Gap.xl}px`, fontSize: Font.sm, fontWeight: Weight.semibold, whiteSpace: 'nowrap', marginLeft: Gap.md } as CSSProperties,
