...
import { Colors, Font, Gap, Weight, Radius, Display, Align, Position, flexColumn, flexCenter, modalOverlay, btnDanger } from '@festival/theme';
...
export const sidebarStyles = {
  ...
  sidebarNav: { ...flexColumn, padding: `${Gap.md}px 0`, flex: 1 } as CSSProperties,
  sidebarFooter: { borderTop: `1px solid ${Colors.borderSubtle}`, padding: `${Gap.md}px 0` } as CSSProperties,
  sidebarLink: { display: 'block', padding: `${Gap.xl}px ${Gap.section}px`, color: Colors.textSecondary, textDecoration: 'none', fontSize: Font.md, transition: 'background-color 0.15s, color 0.15s' } as CSSProperties,
  sidebarLinkActive: { display: 'block', padding: `${Gap.xl}px ${Gap.section}px`, color: Colors.textPrimary, textDecoration: 'none', fontSize: Font.md, transition: 'background-color 0.15s, color 0.15s', backgroundColor: Colors.surfaceSubtle, borderLeft: `3px solid ${Colors.accentPurple}` } as CSSProperties,
  sidebarPlayerRow: { display: Display.flex, alignItems: Align.center } as CSSProperties,
  playerLink: { display: Display.flex, alignItems: Align.center, flex: 1, padding: `${Gap.xl}px ${Gap.section}px`, color: Colors.textSecondary, textDecoration: 'none', fontSize: Font.md, transition: 'background-color 0.15s, color 0.15s' } as CSSProperties,
  ...
  selectPlayerBtn: { display: Display.flex, alignItems: Align.center, padding: `${Gap.xl}px ${Gap.section}px`, color: Colors.textSecondary, fontSize: Font.md, background: 'none', border: 'none', cursor: 'pointer', textDecoration: 'none', transition: 'background-color 0.15s, color 0.15s' } as CSSProperties,
} as const;
