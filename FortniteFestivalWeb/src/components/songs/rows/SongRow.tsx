...
import type { ServerInstrumentKey as InstrumentKey, PlayerScore, ServerSong as Song, SongDifficulty } from '@festival/core/api/serverTypes';
import { InstrumentIcon, getInstrumentStatusVisual } from '../../display/InstrumentIcons';
import AccuracyDisplay from '../metadata/AccuracyDisplay';
