...
import { SelectProfilePill } from './SelectProfilePill';
import SyncBanner from '../page/SyncBanner';
...
import { buildOverallSummaryItems } from '../../pages/player/sections/OverallSummarySection';
import { buildInstrumentStatsItems } from '../../pages/player/sections/InstrumentStatsSection';
import { buildTopSongsItems } from '../../pages/player/components/TopSongsSection';
import type { PlayerItem } from '../../pages/player/helpers/playerPageTypes';
