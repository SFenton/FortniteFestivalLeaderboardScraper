...
export const appStyles = {
  ...
  quickLinksRailPortal: { width: Layout.sidebarWidth, minWidth: 0, minHeight: 0, height: CssValue.full, flexShrink: 0, display: Display.flex, pointerEvents: PointerEvents.none } as CSSProperties,
