...
import { Colors, Gap, Size, ZIndex, Display, Align, Justify, Position, Overflow, Cursor, TRANSITION_MS, FADE_DURATION, transition } from '@festival/theme';

export const filterStyles = {
  instrumentRow: { display: Display.flex, gap: Gap.md, flexWrap: 'wrap', justifyContent: Justify.center } as CSSProperties,
  instrumentBtn: { width: Size.instrumentBtn, height: Size.instrumentBtn, display: Display.flex, alignItems: Align.center, justifyContent: Justify.center, borderRadius: '50%', border: 'none', backgroundColor: 'transparent', cursor: Cursor.pointer, position: Position.relative, overflow: Overflow.hidden } as CSSProperties,
