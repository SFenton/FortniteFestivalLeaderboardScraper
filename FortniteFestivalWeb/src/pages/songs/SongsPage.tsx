...
import { type BandSongPerformance, type PlayerScore, type ServerInstrumentKey as InstrumentKey, DEFAULT_INSTRUMENT, INSTRUMENT_LABELS } from '@festival/core/api';
import { accuracyBgColor, maxScoreColor } from '@festival/core/app/formatters';
