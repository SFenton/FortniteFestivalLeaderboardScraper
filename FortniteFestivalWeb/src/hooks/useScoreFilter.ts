...
import type { InstrumentKey, LeaderboardEntry, PlayerScore, ScoreHistoryEntry } from '../models';
...
export function useScoreFilter() {
  ...
  return { enabled, leewayParam, isScoreValid, filterLeaderboard, filterPlayerScores, filterHistory };
}
