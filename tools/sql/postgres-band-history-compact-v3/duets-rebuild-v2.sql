...
CREATE TABLE public.band_team_rank_history_points_v2_duets
    PARTITION OF public.band_team_rank_history_points_v2
    FOR VALUES IN ('Band_Duets');

INSERT INTO public.band_team_rank_history_points_v2_duets (
    band_type,
    ranking_scope,
    combo_id,
    team_key,
...
FROM public.band_team_rank_history_points_v3_duets points
JOIN public.band_rank_history_team_v3_duets team USING (team_id)
LEFT JOIN public.band_rank_history_combo_v3_duets combo USING (combo_ref);

ANALYZE public.band_team_rank_history_points_v2_duets;
CHECKPOINT;
