...
public sealed class InstrumentDatabase : IInstrumentDatabase
{
    ...
    public int SnapshotRankHistory(int topN, IReadOnlySet<string>? additionalAccountIds = null, int retentionDays = 365)
    {
        ...
        using (var c = conn.CreateCommand()) { c.Transaction = tx; c.CommandText = "INSERT INTO rank_history (account_id, instrument, snapshot_date, adjusted_skill_rank, weighted_rank, fc_rate_rank, total_score_rank, max_score_percent_rank, adjusted_skill_rating, weighted_rating, fc_rate, total_score, max_score_percent, songs_played, coverage, full_combo_count, raw_fc_rate, raw_max_score_percent, schema_version) SELECT account_id, instrument, @today, adjusted_skill_rank, weighted_rank, fc_rate_rank, total_score_rank, max_score_percent_rank, adjusted_skill_rating, weighted_rating, fc_rate, total_score, max_score_percent, songs_played, coverage, full_combo_count, raw_fc_rate, raw_max_score_percent, 2 FROM account_rankings WHERE instrument = @instrument AND adjusted_skill_rank <= @topN ON CONFLICT (account_id, instrument, snapshot_date) DO UPDATE SET adjusted_skill_rank = EXCLUDED.adjusted_skill_rank, weighted_rank = EXCLUDED.weighted_rank, fc_rate_rank = EXCLUDED.fc_rate_rank, total_score_rank = EXCLUDED.total_score_rank, max_score_percent_rank = EXCLUDED.max_score_percent_rank, adjusted_skill_rating = EXCLUDED.adjusted_skill_rating, weighted_rating = EXCLUDED.weighted_rating, fc_rate = EXCLUDED.fc_rate, total_score = EXCLUDED.total_score, max_score_percent = EXCLUDED.max_score_percent, songs_played = EXCLUDED.songs_played, coverage = EXCLUDED.coverage, full_combo_count = EXCLUDED.full_combo_count, raw_fc_rate = EXCLUDED.raw_fc_rate, raw_max_score_percent = EXCLUDED.raw_max_score_percent, schema_version = EXCLUDED.schema_version"; c.Parameters.AddWithValue("today", today); c.Parameters.AddWithValue("instrument", Instrument); c.Parameters.AddWithValue("topN", topN); c.ExecuteNonQuery(); }
        if (additionalAccountIds is { Count: > 0 }) { using var c = conn.CreateCommand(); c.Transaction = tx; c.CommandText = "INSERT INTO rank_history (account_id, instrument, snapshot_date, adjusted_skill_rank, weighted_rank, fc_rate_rank, total_score_rank, max_score_percent_rank, adjusted_skill_rating, weighted_rating, fc_rate, total_score, max_score_percent, songs_played, coverage, full_combo_count, raw_fc_rate, raw_max_score_percent, schema_version) SELECT account_id, instrument, @today, adjusted_skill_rank, weighted_rank, fc_rate_rank, total_score_rank, max_score_percent_rank, adjusted_skill_rating, weighted_rating, fc_rate, total_score, max_score_percent, songs_played, coverage, full_combo_count, raw_fc_rate, raw_max_score_percent, 2 FROM account_rankings WHERE instrument = @instrument AND account_id = @aid ON CONFLICT (account_id, instrument, snapshot_date) DO UPDATE SET adjusted_skill_rank = EXCLUDED.adjusted_skill_rank, weighted_rank = EXCLUDED.weighted_rank, fc_rate_rank = EXCLUDED.fc_rate_rank, total_score_rank = EXCLUDED.total_score_rank, max_score_percent_rank = EXCLUDED.max_score_percent_rank, raw_fc_rate = EXCLUDED.raw_fc_rate, raw_max_score_percent = EXCLUDED.raw_max_score_percent, schema_version = EXCLUDED.schema_version"; c.Parameters.Add("today", NpgsqlTypes.NpgsqlDbType.Date); c.Parameters.AddWithValue("instrument", Instrument); c.Parameters.Add("aid", NpgsqlTypes.NpgsqlDbType.Text); c.Prepare(); foreach (var aid in additionalAccountIds) { c.Parameters["today"].Value = today; c.Parameters["aid"].Value = aid; c.ExecuteNonQuery(); } }
