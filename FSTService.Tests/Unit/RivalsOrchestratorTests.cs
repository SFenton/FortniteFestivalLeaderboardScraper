...
public sealed class RivalsOrchestratorTests : IDisposable
{
        ...
        GlobalLeaderboardPersistence persistence)
    {
        ...
        var orch = new RivalsOrchestrator(calculator, persistence, new Api.NotificationService(Substitute.For<ILogger<Api.NotificationService>>()), progress, NullLogger<RivalsOrchestrator>.Instance);
