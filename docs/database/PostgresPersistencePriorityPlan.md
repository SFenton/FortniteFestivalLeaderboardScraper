...
| Next implementation phase | Stop direct early writers | Route single-user precompute to working publication state, queue catalog/path/max-score changes, move notification projection/detection before publication, and make publication diagnostics truthful without blanket multi-hour 503 behavior. |
