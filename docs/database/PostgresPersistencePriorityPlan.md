...
| Next implementation phase | Build publication ledger/context | Add `publication_generations`, current/previous/working pointers, typed surface manifests, `PublicationReadContext`, and publication-keyed URLs/query keys/caches before shadow A/B and coordinated cutover. |
