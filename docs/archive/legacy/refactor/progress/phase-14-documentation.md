> [!IMPORTANT]
> **Archived progress record.** The proposed documentation surface below was
...
> [!IMPORTANT]
> **Archived progress record.** The proposed documentation work was not the
> current repository state. Use [`docs/README.md`](../../../../README.md).
