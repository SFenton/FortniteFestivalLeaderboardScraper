> [!IMPORTANT]
> **Archived migration guidance.** Use `docs/components/web-app.md` for current
> styling conventions.
...
> [!IMPORTANT]
> **Archived migration guidance.** The migration status and file counts below
> are historical. Current web conventions live in
> [`docs/components/web-app.md`](../../../components/web-app.md).
