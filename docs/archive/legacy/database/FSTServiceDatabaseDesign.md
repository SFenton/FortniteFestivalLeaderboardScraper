> [!IMPORTANT]
> **Archived legacy design.** Schema, cleanup, and rollout state below may be
> stale. Use `docs/architecture/data-storage.md` for current guidance.
...
> [!IMPORTANT]
> **Archived legacy design.** This document contains valuable historical
> reasoning but also stale schema and cleanup state. Current storage
> architecture lives in
> [`docs/architecture/data-storage.md`](../../../architecture/data-storage.md).
