> [!IMPORTANT]
> **Archived rejected rollout evidence.** Do not enable this path without a new
> implementation and acceptance cycle.
...
> [!IMPORTANT]
> **Archived rejected rollout evidence.** Do not enable the evaluated path from
> this document without a new implementation and acceptance cycle.
