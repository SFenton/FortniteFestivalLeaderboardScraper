> [!IMPORTANT]
> **Archived design history.** Implemented and proposed state is mixed below;
> use current architecture documentation.
...
> [!IMPORTANT]
> **Archived design history.** This document mixes implemented work with stale
> next-step language. Current data architecture lives in
