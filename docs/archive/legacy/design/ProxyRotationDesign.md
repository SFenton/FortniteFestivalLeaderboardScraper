> [!IMPORTANT]
> **Archived proposal and rollout history.** Use
> `docs/operations/vpn-proxy-pool.md` for the current proxy design.
...
> [!IMPORTANT]
> **Archived proposal and rollout history.** It does not describe the complete
> current proxy pool. Use
> [`docs/operations/vpn-proxy-pool.md`](../../../operations/vpn-proxy-pool.md).
