...
Songs publishes readiness at `LoadPhase.ContentIn`; Not Found and route-error
fallbacks publish terminal readiness immediately so startup cannot deadlock.
