...
export type PlayerBandListGroup = keyof PlayerBandsResponse;
...
export type PlayerBandListResponse = {
  accountId: string;
  group: PlayerBandListGroup;
  totalCount: number;
  entries: PlayerBandEntry[];
};
...
export type BandRankHistoryResponse = {
  bandType: BandType;
  teamKey: string;
  comboId?: string | null;
  days: number;
