...
5. Put destructive changes, table rewrites, pruning, and `VACUUM FULL` behind the FST live-scrape A/B data-parity gate and fresh exact-object operator authorization through the destructive-maintenance machine. Parity is necessary evidence, never approval; bind rollback and post-action validation.
